...
def mv_armchair(room):
    if room==1
        text(note,blue)
    return prove_note1+=1
def mv_desk():
def mv_cabinet(room):
        if room==4
        text(note2,blue)
    return prove_note2+=1
def mv_cooker():
def mv_sink(room):
    if room==5
        text(flask,blue)
    return prove_flask+=1
def mv_bed(room):
    if room==2
        text(m1911,blue)
    return prove_m1911+=1
def mv_wardrobe():
def mv_nightstand(room):
    if room==3
        text(note3,blue)
    return prove_note3=1
...
def proves
    ...
    if itens_end_4=1 == itens_end_3=1:
        ...
        itens_end_2=0
        itens_end_3=0
    if itens_end_4=1 == itens_end_3=1 and itens_end_4=1 == itens_end_2=1:
        itens_end_1=1
        itens_end_2=0
        itens_end_3=0
